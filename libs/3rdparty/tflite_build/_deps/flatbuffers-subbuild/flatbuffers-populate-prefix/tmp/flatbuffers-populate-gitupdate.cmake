...
execute_process(
  COMMAND "/usr/bin/git" show-ref e6463926479bd6b330cbcf673f7e917803fd5831
  WORKING_DIRECTORY "/home/huucuong/cpp/libs/3rdparty/tflite_build/flatbuffers"
...
if("${show_ref_output}" MATCHES "refs/remotes/e6463926479bd6b330cbcf673f7e917803fd5831")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "e6463926479bd6b330cbcf673f7e917803fd5831")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "e6463926479bd6b330cbcf673f7e917803fd5831")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 e6463926479bd6b330cbcf673f7e917803fd5831
  WORKING_DIRECTORY "/home/huucuong/cpp/libs/3rdparty/tflite_build/flatbuffers"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/huucuong/cpp/libs/3rdparty/tflite_build/flatbuffers/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/huucuong/cpp/libs/3rdparty/tflite_build/flatbuffers/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
